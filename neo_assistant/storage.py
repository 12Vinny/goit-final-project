...
def load_data(filename, default_class):
    ...
    default_class: клас, екземпляр якого треба створити, якщо файлу немає 
    ...
    if os.path.exists(filename):
        try:
            ...
            # Якщо файл порожній або пошкоджений (наприклад, раптово вимкнули світло під час запису),
            # програма не впаде з помилкою, а просто почне з чистого аркуша.
